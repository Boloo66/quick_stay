...
const Hero = () => {
  return (
    <div
      className="min-h-screen flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-cover bg-center mb-2 bg-no-repeat"
    ...
    >
      ...
      <h1 className="font-fairplay text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4">
