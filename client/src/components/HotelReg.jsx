...
const HotelReg = () => {
  return (
    <div className="fixed top-0 bottom-0 left-0 right-0 z-2 flex items-center justify-center bg-black/70">
      <form className="flex bg-white rounded-xl mx-4xl max-md:mx-2">
        <img
          src={assets.regImage}
          alt="reg-image"
